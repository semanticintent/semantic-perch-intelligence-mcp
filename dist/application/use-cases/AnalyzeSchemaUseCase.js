...
exports.AnalyzeSchemaUseCase = void 0;
/**
...
class AnalyzeSchemaUseCase {
     ...
     */
    async formatResponse(schema, includeSamples, maxSampleRows) {
        const tables = [];
     ...
     */
    async fetchSampleData(databaseId, tableName, maxRows) {
        try {
...
exports.AnalyzeSchemaUseCase = AnalyzeSchemaUseCase;
//# sourceMappingURL=AnalyzeSchemaUseCase.js.map