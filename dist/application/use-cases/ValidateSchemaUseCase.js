...
exports.ValidateSchemaUseCase = exports.ValidationSeverity = void 0;
/**
...
class ValidateSchemaUseCase {
    ...
    constructor(repository, schemaAnalyzer, databaseConfig, cache) {
        ...
        for (const table of schema.tables) {
            ...
            for (const fk of table.foreignKeys) {
                ...
                if (!referencedTableExists) {
                    ...
                    const referencedColumnExists = referencedTable?.columns.some((col) => col.name === fk.referencesColumn);
...
exports.ValidateSchemaUseCase = ValidateSchemaUseCase;
//# sourceMappingURL=ValidateSchemaUseCase.js.map